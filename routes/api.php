...
Route::group([
    ...
    Route::get('/barangs/mitra/{mitra_id}', [BarangController::class, 'getBarangsByMitraId']);
...
Route::get("mitra/show", [AuthmitraController::class, "show"])->middleware('auth:sanctum');
